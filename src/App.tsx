...
function App() {
  ...
  useEffect(() => {
    ...
    // }
    // fetchData();
    setImageURL("https://images.unsplash.com/photo-1723027336855-794d5509ac44?ixid=M3w2NDMyNDl8MHwxfHJhbmRvbXx8fHx8fHx8fDE3MjM1NDkyMzJ8\u0026ixlib=rb-4.0.3");
  },[])

  return (
    <div className="flex h-screen overflow-clip gap-0">
      <div className="w-[40%] h-full relative text-left text-white">
        <img title="sesuatu" src={imageURL} className="brightness-50 h-full w-full object-cover" />
